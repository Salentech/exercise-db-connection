    ...
    public class ReviewRepositoryTests
    {
        ...
        public ReviewRepositoryTests()
        {
            ...
            _context.Reviews.AddRange(
                ...
                new Review { BookId = book2.Id, ReviewerName = "Charlie", Content = "Could be better", Rating = 2, Book = book2 }
            );
            _context.SaveChanges();
        }
        ...
        public async Task AddReview_AddsNewReview()
        {
            ...
            var newReview = new Review { BookId = book.Id, ReviewerName = "David", Content = "Amazing!", Rating = 4, Book = book };
